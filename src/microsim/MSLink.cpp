...
MSLink::getZipperSpeed(const MSVehicle* ego, const double dist, double vSafe,
    ...
    for (const auto& item : *collectFoes) {
        ...
        const double uAccel = foe->getCarFollowModel().estimateSpeedAfterDistance(foeDist, avi.speed, ego->getMaxSpeed(), foe->getMaxAccel());
        ...
        const double vAccel = ego->getCarFollowModel().estimateSpeedAfterDistance(dist, ego->getSpeed(), ego->getMaxSpeed(), ego->getMaxAccel());
        const double vDecel = ego->getCarFollowModel().estimateSpeedAfterDistance(dist, ego->getSpeed(), ego->getMaxSpeed(), ego->getMaxAccel());
